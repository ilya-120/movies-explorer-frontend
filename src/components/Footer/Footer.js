    ...
    <footer className='footer'>
      ...
      <div className='footer__info'>
        ...
        <div className='footer__links'>
          ...
          <a className='footer__link' href='https://github.com/ilya-120' target='_blank' rel="noopener noreferrer">Github</a>
          <a className='footer__link' href='https://t.me/ilya_120' target='_blank' rel="noopener noreferrer">Telegram</a>
        </div>
      </div>
